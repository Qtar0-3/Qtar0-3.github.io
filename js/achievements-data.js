...
const DEFAULT_ACHIEVEMENTS = [
  ...
  { id: "wig-make",     cat: "wig", icon: "🧵", title: "ウィッグ職人", desc: "ウィッグを自作した" },
  { id: "wig-kedaba",   cat: "wig", icon: "🦁", title: "毛束マイスター", desc: "毛束を使ってウィッグを作った・盛った" },
  { id: "wig-ahoge",    cat: "wig", icon: "📡", title: "アホ毛アンテナ", desc: "アホ毛を自立させた" },
  { id: "wig-twin",     cat: "wig", icon: "🎏", title: "ツインテール属性", desc: "ツインテールキャラをした" },
  { id: "wig-long",     cat: "wig", icon: "🧜", title: "ロングヘアの覚悟", desc: "膝丈クラスの超ロングウィッグを扱った" },
  { id: "wig-color",    cat: "wig", icon: "🌈", title: "カラーリスト", desc: "ウィッグを染めた・グラデーションを作った" },
  { id: "wig-gravity",  cat: "wig", icon: "🚀", title: "重力への反逆", desc: "物理法則を無視した髪型を再現した" },

  // --- 衣装 ---
  { id: "costume-buy",     cat: "costume", icon: "🛍️", title: "はじめの一歩", desc: "衣装を購入してコスプレした" },
  { id: "costume-make",    cat: "costume", icon: "🪡", title: "お針子デビュー", desc: "衣装を自作した" },
  { id: "costume-pattern", cat: "costume", icon: "📐", title: "型紙使い", desc: "型紙を引いて衣装を作った" },
  { id: "costume-remake",  cat: "costume", icon: "♻️", title: "リメイク錬金術師", desc: "既製服をリメイクして衣装にした" },
  { id: "sewing-machine",  cat: "costume", icon: "🧷", title: "相棒（ミシン）", desc: "自分のミシンを手に入れた" },
  { id: "costume-armor",   cat: "costume", icon: "🛡️", title: "鎧鍛冶", desc: "鎧・アーマーを制作した" },
  { id: "costume-night",   cat: "costume", icon: "🌙", title: "納期の魔物", desc: "イベント前日に徹夜で衣装を作った" },
  { id: "glue-gun",        cat: "costume", icon: "🔥", title: "グルーガンの洗礼", desc: "グルーガンでやけどした" },
  { id: "costume-kimono",  cat: "costume", icon: "👘", title: "和装の心得", desc: "和装キャラをした" },
  { id: "costume-school",  cat: "costume", icon: "🎒", title: "永遠の学生", desc: "制服キャラをした" },

  // --- 小物・造形 ---
  { id: "prop-make",   cat: "prop", icon: "🔨", title: "小物クラフター", desc: "小物・アクセサリーを自作した" },
  { id: "prop-weapon", cat: "prop", icon: "⚔️", title: "武器商人", desc: "剣・銃などの武器を作った" },
